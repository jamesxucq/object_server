...
${OBJECTDIR}/config.o: config.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/config.o config.c

${OBJECTDIR}/cur_json.o: cur_json.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/cur_json.o cur_json.c

${OBJECTDIR}/hex.o: hex.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/hex.o hex.c

${OBJECTDIR}/os_alloc.o: os_alloc.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/os_alloc.o os_alloc.c

${OBJECTDIR}/os_errno.o: os_errno.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/os_errno.o os_errno.c

${OBJECTDIR}/pack_api.o: pack_api.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/pack_api.o pack_api.c

${OBJECTDIR}/pack_item.o: pack_item.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/pack_item.o pack_item.c

${OBJECTDIR}/pack_stream.o: pack_stream.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/pack_stream.o pack_stream.c
...
${TESTDIR}/tests/apisimpletest.o: tests/apisimpletest.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/apisimpletest.o tests/apisimpletest.c
...
${OBJECTDIR}/config_nomain.o: ${OBJECTDIR}/config.o config.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/config_nomain.o config.c;\
	else  \
...
${OBJECTDIR}/cur_json_nomain.o: ${OBJECTDIR}/cur_json.o cur_json.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/cur_json_nomain.o cur_json.c;\
	else  \
...
${OBJECTDIR}/hex_nomain.o: ${OBJECTDIR}/hex.o hex.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/hex_nomain.o hex.c;\
	else  \
...
${OBJECTDIR}/os_alloc_nomain.o: ${OBJECTDIR}/os_alloc.o os_alloc.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/os_alloc_nomain.o os_alloc.c;\
	else  \
...
${OBJECTDIR}/os_errno_nomain.o: ${OBJECTDIR}/os_errno.o os_errno.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/os_errno_nomain.o os_errno.c;\
	else  \
...
${OBJECTDIR}/pack_api_nomain.o: ${OBJECTDIR}/pack_api.o pack_api.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/pack_api_nomain.o pack_api.c;\
	else  \
...
${OBJECTDIR}/pack_item_nomain.o: ${OBJECTDIR}/pack_item.o pack_item.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/pack_item_nomain.o pack_item.c;\
	else  \
...
${OBJECTDIR}/pack_stream_nomain.o: ${OBJECTDIR}/pack_stream.o pack_stream.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/pack_stream_nomain.o pack_stream.c;\
	else  \
