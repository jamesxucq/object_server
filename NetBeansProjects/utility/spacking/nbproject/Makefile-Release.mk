...
${OBJECTDIR}/_ext/6bbad5da/config.o: ../packing/config.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/6bbad5da/config.o ../packing/config.c

${OBJECTDIR}/_ext/6bbad5da/cur_json.o: ../packing/cur_json.c
	${MKDIR} -p ${OBJECTDIR}/_ext/6bbad5da
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/6bbad5da/cur_json.o ../packing/cur_json.c

${OBJECTDIR}/_ext/6bbad5da/hex.o: ../packing/hex.c
	${MKDIR} -p ${OBJECTDIR}/_ext/6bbad5da
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/6bbad5da/hex.o ../packing/hex.c

${OBJECTDIR}/_ext/6bbad5da/os_alloc.o: ../packing/os_alloc.c
	${MKDIR} -p ${OBJECTDIR}/_ext/6bbad5da
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/6bbad5da/os_alloc.o ../packing/os_alloc.c

${OBJECTDIR}/_ext/6bbad5da/os_errno.o: ../packing/os_errno.c
	${MKDIR} -p ${OBJECTDIR}/_ext/6bbad5da
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/6bbad5da/os_errno.o ../packing/os_errno.c

${OBJECTDIR}/_ext/6bbad5da/pack_api.o: ../packing/pack_api.c
	${MKDIR} -p ${OBJECTDIR}/_ext/6bbad5da
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/6bbad5da/pack_api.o ../packing/pack_api.c

${OBJECTDIR}/_ext/6bbad5da/pack_item.o: ../packing/pack_item.c
	${MKDIR} -p ${OBJECTDIR}/_ext/6bbad5da
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/6bbad5da/pack_item.o ../packing/pack_item.c

${OBJECTDIR}/_ext/6bbad5da/pack_stream.o: ../packing/pack_stream.c
	${MKDIR} -p ${OBJECTDIR}/_ext/6bbad5da
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/6bbad5da/pack_stream.o ../packing/pack_stream.c
