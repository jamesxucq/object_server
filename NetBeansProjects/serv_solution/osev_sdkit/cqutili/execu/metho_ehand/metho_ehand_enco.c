...
static int hand_not_equal(plan_node_enco *querpn, physi_conte *phys_cont, rive_ha *stora_ha, lev1me *lv1me) {
    int hand_valu = 0x00;
...
static int hand_equal(plan_node_enco *querpn, physi_conte *phys_cont, rive_ha *stora_ha, lev1me *lv1me) {
    int hand_valu = 0x00;
...
static int hand_great_than(plan_node_enco *querpn, physi_conte *phys_cont, rive_ha *stora_ha, lev1me *lv1me) {
    int hand_valu = 0x00;
...
static int hand_less_equal(plan_node_enco *querpn, physi_conte *phys_cont, rive_ha *stora_ha, lev1me *lv1me) {
    int hand_valu = 0x00;
...
static int hand_less_than(plan_node_enco *querpn, physi_conte *phys_cont, rive_ha *stora_ha, lev1me *lv1me) {
    int hand_valu = 0x00;
...
static int hand_great_equal(plan_node_enco *querpn, physi_conte *phys_cont, rive_ha *stora_ha, lev1me *lv1me) {
    int hand_valu = 0x00;
...
int hand_metho_set_enco(plan_node_enco *querpn, physi_conte *phys_cont, rive_ha *stora_ha, lev1me *lv1me) {
    int hand_valu = 0x00;
