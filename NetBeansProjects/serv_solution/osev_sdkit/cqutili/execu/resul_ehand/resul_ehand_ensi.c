...
static int hand_not_equal(plan_node_ensi *querpn, physi_conte *phys_cont, rive_ha *stora_ha) {
    int hand_valu = 0x00;
...
static int hand_equal(plan_node_ensi *querpn, physi_conte *phys_cont, rive_ha *stora_ha) {
    int hand_valu = 0x00;
...
static int hand_great_than(plan_node_ensi *querpn, physi_conte *phys_cont, rive_ha *stora_ha) {
    int hand_valu = 0x00;
...
static int hand_less_equal(plan_node_ensi *querpn, physi_conte *phys_cont, rive_ha *stora_ha) {
    int hand_valu = 0x00;
...
static int hand_less_than(plan_node_ensi *querpn, physi_conte *phys_cont, rive_ha *stora_ha) {
    int hand_valu = 0x00;
...
static int hand_great_equal(plan_node_ensi *querpn, physi_conte *phys_cont, rive_ha *stora_ha) {
    int hand_valu = 0x00;
...
int hand_resul_set_ensi(plan_node_ensi *querpn, physi_conte *phys_cont, rive_ha *stora_ha) {
    int hand_valu = 0x00;
    // NOT IS MATCH LIKE_KW BETWEEN IN NOT_EQUAL EQUAL 
    // GREAT_THAN LESS_EQUAL LESS_THAN GREAT_EQUAL ESCAPE PLUS MINUS
