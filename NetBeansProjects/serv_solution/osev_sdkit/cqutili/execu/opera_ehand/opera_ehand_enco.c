...
static int hand_or(plan_node_enco *querpn) {
...
static int hand_and(plan_node_enco *querpn) {
    plan_node_enco *left_chil, *righ_chil;
...
int hand_opera_set_enco(plan_node_enco *querpn) { // OR AND
    OSEVPF("[FUNC]:hand_opera_set_enco\n");
    int hand_valu = 0x00;
    //
