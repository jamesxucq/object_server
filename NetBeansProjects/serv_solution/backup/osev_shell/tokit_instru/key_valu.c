...
static char *prin_record(char *resul_str, const char *resdat) {
    ...
    sidstr_se(plai_stid, (cli_sid_t *) resdat);
...
static int pretty_variable_echo(clie_resu *resul, char *prestr, char *resp_data, uint64 quer_leng) {
...
int kits_keyval(char **pamvp, clie_resu *resul) {
    CLIEPF("[FUNC]:kits_keyval.\n");
    // pamvu = 1
