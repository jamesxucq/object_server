...
int entit_leng_tab[] = {
    0x00, // DATY_INVAL
    //
    sizeof (byte_entit), // DATY_BYTE
    sizeof (ubyte_entit), // DATY_UBYTE
    sizeof (short_entit), // DATY_SHORT
    sizeof (ushort_entit), // DATY_USHORT
    sizeof (int_entit), // DATY_INT
    sizeof (uint_entit), // DATY_UINT
    sizeof (llong_entit), // DATY_LLONG
    sizeof (ullong_entit), // DATY_ULLONG
    sizeof (obid_entit), // DATY_OBID
    sizeof (float_entit), // DATY_FLOAT
    sizeof (double_entit), // DATY_DOUBLE
    0x00, // DATY_STRI
    0x00, // DATY_STRZ// NUL-terminated
    0x00 // DATY_BINARY
};