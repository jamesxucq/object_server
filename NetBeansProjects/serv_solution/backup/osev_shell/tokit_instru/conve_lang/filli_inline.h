...
extern "C" {
    ...
    static inline int produ_resul_conte(clie_resu *resul, char *resu_cont) {
    ...
    static inline char *filli_lv2p_head(char *clang_str, char *lv2pn, char *basen) {
        ...
        last_str = lscpy(last_str, "#include \"third_party.h\" \n\n");
        last_str = lscpy(last_str, "#include \"osev_common/obid.h\" \n\n");
