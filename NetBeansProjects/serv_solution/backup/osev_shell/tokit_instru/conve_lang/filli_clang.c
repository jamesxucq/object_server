...
int filli_lv2p_conte(clie_resu *resul, char *clang_str, char *lv2pn, char *basen) {
    CLIEPF("[FUNC]:filli_lv2p_conte\n");
...
int filli_lev1_conte(clie_resu *resul, char *clang_str, char *lv2pn, char *basen) {
    char resu_cont[CLANG_CONTE_SIZE];
    MK_ZERO(resu_cont);
    //
...
int filli_ointe_comple(char *line_oivk, char (*oivk_data)[PARAM_LENGTH]) {
    // CLIEPF("[FUNC]:conve_ointe_comple\n");
