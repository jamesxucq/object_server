...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/helloworld: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/helloworld ${OBJECTFILES} ${LDLIBSOPTIONS} -lOSEVClieCPP -lpacking
...
${OBJECTDIR}/helloworld.o: helloworld.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -I../../../../serv_solution/third_party -I../../../../serv_solution -I../../OSEVClieCPP -I../../../../serv_solution/osev_common -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/helloworld.o helloworld.cpp

${OBJECTDIR}/main.o: main.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../../../serv_solution/third_party -I../../../../serv_solution -I../../OSEVClieCPP -I../../../../serv_solution/osev_common -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main.o main.cpp
